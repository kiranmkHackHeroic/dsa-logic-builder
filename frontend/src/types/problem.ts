...
export const PATTERN_COLORS: Record<string, string> = {
  ...
  "Binary Search": "bg-sky-500/10 text-sky-500",
  "Stack": "bg-orange-500/10 text-orange-500",
  "Dynamic Programming": "bg-pink-500/10 text-pink-500",
  "Greedy": "bg-amber-500/10 text-amber-500",
  "Hash Map": "bg-cyan-500/10 text-cyan-500",
  "Trees": "bg-indigo-500/10 text-indigo-500",
  "Graph": "bg-violet-500/10 text-violet-500",
  "Linked List": "bg-blue-600/10 text-blue-600",
